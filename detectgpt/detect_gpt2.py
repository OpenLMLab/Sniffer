...
if __name__ == "__main__":
    ...
    samples_test = samples_test[0:2100]
    ...
    for idx, item in tqdm(enumerate(samples_test)):
        ...
        # gpt2, human
        if label != 'gpt2' and label != 'human':
            continue
        assert label == 'gpt2' or label == 'human', " ERROR: label != 'gpt2' and label != 'human'' "
        # if label != 'gptj' and label != 'gptneo' and label != 'gpt3re' and label != 'gpt3sum':
        #     continue
        # assert label == 'gptj' or label == 'gptneo' or label == 'gpt3re' or label == 'gpt3sum', " ERROR: label != 'gptj' and label != 'gptneo' and label != 'gpt3re' and label != 'gpt3sum' "

        t5_url = "http://10.176.52.119:20037/inference"
        url = "http://10.176.52.120:20098/inference"
        ptb_num = 40
        ...
        try:
            ...
            detect_gpt2_samples.append(item)
    ...
    with open(
        ...
        json.dump(detect_gpt2_samples, f)
